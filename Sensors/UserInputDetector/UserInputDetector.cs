...
using System.Linq;
using System.Timers;
using UserInputDetector.Internals;

namespace UserInputDetector
{
    [Export(typeof(ISensor))]
    [PartCreationPolicy(CreationPolicy.NonShared)]
    [SensorMetadata(
        Name = "UserInputDetector",
        ...
        Parameters = "OffDelaySeconds: uint {300}")]
    public class UserInputDetector : ISensor, ISendStatusChangesIn
    {
        ...
        {
            uint inputIdleSeconds = WinAPIWrapper.InputIdleSeconds;
